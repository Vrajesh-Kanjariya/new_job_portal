...
import 'package:new_job_portal/controller/filter_list_controller.dart';
...
class FilterListPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<FilterListController>(
      ...
      builder: (FilterListController controller) {
        return Scaffold(
          appBar: appBar(),
          body: _filterListBody(controller),
  ...
  appBar() {
    return AppAppBar(
      appbarTitle: 'Jobs'.toUpperCase(),
      titleFontSize: 14,
    );
  }

  _filterListBody(FilterListController controller) {
    return Stack(
      children: [
          ...
          Padding(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return InkWell(
                  onTap: () => gotoJobDetails(controller.job![index]),
                  child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: AppText(
                                text: controller.job![index].jobType,
                            ...
                            Row(
                              children: [
                                ...
                                AppText(
                                  text:
                                      '${controller.job![index].city}, '
                                          '${controller.job![index].country}',
                                  fontSize: 14.px,
                                ),
                                const Spacer(),
                                Text.rich(
                                  TextSpan(
                                    text: controller.job![index].salary,
