          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                if (controller.getJobResponse != null)
                  Expanded(
                    child: Container(
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          AppImageAsset(
                                            image:
                                                '${ImageConstant.baseUrl}${controller.getJobResponse!.jobs![index].company!.first.logo}',
                                            isWebImage: true,
                                            height: 60.px,
                                            width: 60.px,
                                          ),
                                          ...
                                          Expanded(
                                            child: Column(
                                              ...
                                              children: [
                                                AppText(
                                                  text:
                                                      controller.getJobResponse!.jobs![index].title,
                                                  fontSize: 16.px,
                                                ...
                                                AppText(
                                                  text: controller.getJobResponse!.jobs![index]
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          AppText(
                                            text:
                                                '${controller.getJobResponse!.jobs![index].city}, ${controller.getJobResponse!.jobs![index].country}',
                                            fontSize: 14.px,
                                          ),
                                          const Spacer(),
                                          Text.rich(
