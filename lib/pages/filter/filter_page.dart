          ...
          body: SafeArea(
            child: ListView(
              ...
              children: [
                ...
                const AppText(
                  text:
                      'Find,\ncreate trackable resumes and enrich your applications,Carefully crafted after analyzing the needs of diffrent industries.',
                  maxLines: 4,
                ...
                AppDropdownButton(
                  hint: controller.jobFiled.first,
                  value: controller.selectedJobFiled,
                  dropdownItems: controller.jobFiled,
                ...
                const SizedBox(height: 15),
                AppDropdownButton(
                  hint: controller.countryList.isNotEmpty ? controller.countryList.first : '',
                ...
                const SizedBox(height: 15),
                AppDropdownButton(
                  hint: controller.stateList.isNotEmpty ? controller.stateList.first : 'Select state',
                  dropdownHeight: Device.height / 3,
                ...
                const SizedBox(height: 15),
                AppDropdownButton(
                  hint: controller.cityList.isNotEmpty ? controller.cityList.first : 'Select city',
                  dropdownHeight: Device.height / 3,
